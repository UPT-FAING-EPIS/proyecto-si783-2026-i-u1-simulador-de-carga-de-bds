...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand('simulador-bd.open', () => {
...
class SimuladorPanel {
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(SimuladorPanel.viewType, 'Simulador de Carga de BD', column ?? vscode.ViewColumn.One, {
            enableScripts: true,
...
SimuladorPanel.viewType = 'simuladorBD';
